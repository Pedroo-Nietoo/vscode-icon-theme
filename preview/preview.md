...
| brackets-light-blue        | ![brackets-light-blue](files/brackets-light-blue.png)                 |
| brackets-light-green       | ![brackets-light-green](files/brackets-light-green.png)               |
...
| code-light-blue            | ![code-light-blue](files/code-light-blue.png)                         |
...
| folder-cart                | ![folder-cart](folders/folder-cart.png)                               |
...
| folder-light-blue          | ![folder-light-blue](folders/folder-light-blue.png)                   |
| folder-light-blue-code     | ![folder-light-blue-code](folders/folder-light-blue-code.png)         |
| folder-light-blue-outline  | ![folder-light-blue-outline](folders/folder-light-blue-outline.png)   |
| folder-light-green         | ![folder-light-green](folders/folder-light-green.png)                 |
| folder-light-green-code    | ![folder-light-green-code](folders/folder-light-green-code.png)       |
| folder-light-green-outline | ![folder-light-green-outline](folders/folder-light-green-outline.png) |
...
| folder-redux-actions       | ![folder-redux-actions](folders/folder-redux-actions.png )            |
| folder-redux-effects       | ![folder-redux-effects](folders/folder-redux-effects.png )            |
| folder-redux-facade        | ![folder-redux-facade](folders/folder-redux-facade.png)               |
| folder-redux-reducer       | ![folder-redux-reducer](folders/folder-redux-reducer.png )            |
| folder-redux-selector      | ![folder-redux-selector](folders/folder-redux-selector.png )          |
